...
class ReservationConfirmationDecision(BaseModel):
    ...
    confirm: Optional[bool] = Field(
        description=(
            "True for explicit confirmation to submit, False for explicit cancellation, "
            "and null when the user asks to modify details, asks follow-up questions, "
...
RESERVATION_FIELD_DISPLAY: dict[ReservationField, str] = {
    "facility": "📍 Facility",
    "date": "📅 Date",
    "start_time": "🕐 Start time",
    "duration_hours": "⏱️ Duration (hours)",
    "customer_name": "👤 Your name",
    "vehicle_plate": "🚗 Vehicle plate number",
}

RESERVATION_DISPLAY_ORDER: list[ReservationField] = [
    "facility",
    "date",
    "start_time",
    "customer_name",
